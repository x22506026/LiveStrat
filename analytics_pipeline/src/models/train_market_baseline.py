...
# this file trains an unscaled leakage-safe baseline model using market features

SYMBOL = DEFAULT_SYMBOL
TIMEFRAME = DEFAULT_TIMEFRAME
MODEL_NAME = "baseline_unscaled"
...
def train_baseline_model():
    ...
    # explicit feature selection prevents future-derived leakage
    ...
    # multi class handling is automatic with lbfgs in many sklearn versions
    ...
    print_evaluation_summary("baseline market model evaluation", y_test, y_pred)
